...
const TRANSLATIONS_RU = {
  ...
  hero_p2: "До этого почти три года был квант-аналитиком в Управлении рисками финансовых рынков Райффайзенбанка, а ещё раньше моделировал риски в Банке России.",
