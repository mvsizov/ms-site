...
const TRANSLATIONS_RU = {
  ...
  hero_p2: "До этого почти три года был старшим квант-аналитиком (VP) в управлении рисками финансовых рынков Райффайзенбанка, а ещё раньше моделировал риски в Банке России.",
  hero_p3: "Окончил НИУ ВШЭ: магистратура Data Science на ФКН и бакалавриат «Экономика и финансы» в МИЭФ — с двойным дипломом London School of Economics. Есть сертификат FRM (Part I & II).",
  hero_p4: "Параллельно вёл в ВШЭ курсы Quantitative Finance и Asset Pricing & Financial Markets.",
  hero_p5: "Собираю небольшие продукты в финтехе, инвестициях и риск-менеджменте — они превращают аналитические идеи в то, чем реально можно пользоваться.",
  ...
  r_b11: "Спроектировал и развернул внутренний LLM-чат-бот: понимает вопросы пользователя, генерирует SQL и достаёт актуальные риск-данные из внутренних систем.",
  ...
  r_b14: "Собрал AI-портфель акций — бенчмарк для оценки фондов: отбор бумаг и расчёт доходности по структурированным данным компаний и макро, с понятным обоснованием каждого решения.",
  ...
  r_b22: "Обновил модели досрочного погашения по розничным кредитам и intraday-модели ликвидности по корпоративным обязательствам.",
  r_role3: "Quantitative Analyst — Управление рисками финансовых рынков",
  r_period3: "Май 2023 — Июн 2024 · 1 г 2 мес",
  r_b31: "Построил модели оценки риска ликвидности и процентного риска корпоративных и розничных обязательств, включая внебалансовые компоненты.",
  ...
  cbr_b12: "С помощью симуляций присваивал PD кредитным рейтингам.",
  cbr_b13: "Валидировал модели прогноза доходов и предлагал требования к данным, которые банки передают регулятору.",
  ...
  cbr_b21: "Разработал стохастическую модель балансов банков с помощью методов оптимизации.",
  ...
  i_vc_b1: "Анализировал метрики стартапов, разрабатывал и презентовал скоринговые модели, напрямую общался с фаундерами.",
  i_mars_role: "FP&amp;A Trainee — Mars Wrigley",
  i_mars_period: "Май 2021 — Окт 2021",
  i_mars_b1: "Анализировал P&amp;L и cashflow, консолидировал KPI, поддерживал финансовое планирование.",
  i_ms_role: "Private Equity Analyst Intern — Milestone Capital",
  i_ms_period: "Мар 2021 — Июн 2021",
  i_ms_b1: "Работал с базами при анализе компаний; готовил саммари по CIM и тизерам; проводил отраслевые исследования.",
  ...
  frm_p: "Сертификат Financial Risk Manager (GARP).",
  langs_eyebrow: "языки и инструменты",
  langs_title: "Python, SQL, R",
  langs_p: "Русский — родной, английский — свободный (IELTS 7.5).",

  // projects
  proj_eyebrow: "проекты",
  proj_title: "Что я создаю",
  proj_filter_all: "все",
  proj_empty_eyebrow: "в разработке",
  proj_empty_copy: 'Скоро здесь появятся проекты. Загляни позже или <a href="./index.html#contact">напиши</a>, если хочешь узнать о них раньше.',
  ...
  posts_empty_copy: "Скоро здесь появятся записи — короткие заметки и ссылки на Telegram, YouTube и другие площадки.",
